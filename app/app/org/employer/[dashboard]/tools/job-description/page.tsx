...
export default function JobDescriptionTool() {
    ...
    const handleGenerate = async () => {
        ...
        const prompt = `
            You are an expert HR specialist. Write a comprehensive Job Description for a ${title}.
            
            Include these keywords/requirements: ${keywords}
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Create professional JDs in seconds.</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="card p-6 border border-gray-800 bg-[#15171e]">
                            ...
                            <textarea
                                ...
                                placeholder="e.g. TypeScript, Node.js, Remote, 5+ years exp..."
                            />
                        </div>
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>Generate Description <Send className="w-4 h-4" /></>
                            )}
                        </button>
                    </div>
