            ...
            const res = await fetch(`/api/jobs/${jobId}`, {
                ...
                body: JSON.stringify({
                    ...
                    salary_range_min: formData.salary_range_min
                        ? parseInt(formData.salary_range_min, 10)
                        : null,
                    salary_range_max: formData.salary_range_max
                        ? parseInt(formData.salary_range_max, 10)
                        : null,
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-[var(--foreground-secondary)]">
                        Update the job details below. Draft jobs stay private until you
                        publish them.
                    </p>
                </div>
