...
- How to install the Stripe Ruby SDK v18.1.0
...
The latest version of the Stripe Ruby server-side SDK is v18.1.0. It supports Ruby versions 2.3+.
...
- How to install the latest Stripe Python SDK v14.1.0
- How to send your first SDK request
...
The latest version of the Stripe Python server-side SDK is v14.1.0. It supports Python versions 3.6+.
...
- How to install the latest Stripe Go SDK v84.1.0
- How to send your first SDK request
...
The latest version of the Stripe Go server-side SDK is v84.1.0. It supports Go versions 1.15+.
...
require github.com/stripe/stripe-go/v84 84.1.0 // indirect
```
...
- How to install the latest Stripe Java SDK v31.1.0
- How to send your first SDK request
...
The latest version of the Stripe Java server-side SDK is v31.1.0. It supports Java versions 1.8+.
...
- How to install the latest Stripe Node SDK v20.1.0
- How to send your first SDK request
...
The latest version of the Stripe Node.js server-side SDK is v20.1.0. It supports Node.js versions 12+.
...
- How to install the latest Stripe PHP SDK v19.1.0
- How to send your first SDK request
...
The latest version of the Stripe PHP server-side SDK is v19.1.0. It supports PHP versions 5.6.0+.
...
- How to install the latest Stripe .NET SDK v50.1.0
- How to send your first SDK request
...
The latest version of the Stripe .NET server-side SDK is v50.1.0. It supports .NET Standard 2.0+, .NET Core 2.0+, and .NET Framework 4.6.1+.
